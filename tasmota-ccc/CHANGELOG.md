...
- Configure log format for the app
- Update App base image to v17.1.0 (Update Alpine base image to v3.21)

## 0.1.16

- Drop support for armhf & i386
- Update App base image to v15.0.0 (Update Alpine base image to v3.19.0)
...
- Update App base image to v14.0.5
...
- Update App base image to v14.0.1
...
- Proxy to the Tasmota admin pages generated at app start, no dynamic refresh
